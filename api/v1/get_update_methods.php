...
if($device_id != null && $device_id != "") {
    ...
    $query = $database->prepare("SELECT um.id, um.english_name, um.dutch_name, um.recommended_for_non_rooted_device AS recommended FROM update_method um JOIN device_update_method du ON um.id = du.update_method_id WHERE du.device_id = :device_id AND um.enabled = TRUE");
