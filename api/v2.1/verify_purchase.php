...
$query = $database->prepare("INSERT INTO purchase(order_id, package_name, product_id, purchase_type, item_type, purchase_state, developer_payload, purchase_token, purchase_signature, purchase_time, auto_renewing) VALUES (:order_id, :package_name, :product_id, :purchase_type, :item_type, :purchase_state, :developer_payload, :purchase_token, :purchase_signature, :purchase_time, :auto_renewing)");
